...
public class XmlConfigTest {
	...
	public static void main(String[] args) {
		//testBeanFactory01();	// XML Auto Configuration(Annotation Scanning)
		
		//testBeanFactory02();	// XML Bean Configuration(Explicit Configuration)
		
		//testApplicationContext01(); // XML Auto Configuration(Annotation Configuration)
		
		testApplicationContext02(); // XML Bean Configuration(Explicit Configuration)
	}
